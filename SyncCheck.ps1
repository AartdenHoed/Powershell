...
# END OF COMMON CODING
    ...
    $dir = $ADHC_TempDirectory + $ADHC_SyncCheck.Directory
    New-Item -ItemType Directory -Force -Path $dir | Out-Null
    $TempFile = $dir + $ADHC_SyncCheck.Name
    ...
    $msg = "----------Overview of Sync conficts".PadRight(120,"-") 
    ...
    try {
        ...
        $deffile = $ADHC_OutputDirectory + $ADHC_SyncCheck.Directory + $ADHC_SyncCheck.Name 
